因为在此之前，我自学了一点网上的python教程（只是了解了基本的字符串，列表，字典，元组，条件语句以及函数之外，再往下学习就显得很吃力了），所以再看到《笨方法学python》，就感觉相对容易理解一点，不过我从中还是学到很多东西的。
...
前二十一道题，包括基本的语法结构，数字计算，打印及文件操作等整体还算顺畅，虽然之前接触过，但每道题都认真做了一遍。关于函数这一块，相对来说困难一点，能看懂习题，但刚开始对print和return理解不是太好，于是就老老实实的按照课后的要求，同时用两者返回一些值，观察区别，逐渐地理解了。**关于每道题后面的附加题，文字性的东西大都添加进了note里面，需要编程及注释的我都添加在了每节的主习题里面。**
